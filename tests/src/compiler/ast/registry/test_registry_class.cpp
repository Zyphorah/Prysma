...
TEST_CASE("Recuperation d'une classe inexistante lance exception", "[RegistryClassGlobal]") {
    RegistryClassGlobal registry;
    CHECK_THROWS_AS(registry.get("ClasseFantome"), std::invalid_argument);
}

TEST_CASE("Enregistryment et recuperation d'une classe valide", "[RegistryClassGlobal]") {
    RegistryClassGlobal registry;
...
TEST_CASE("Ecrasement d'une classe existante avec la meme cle", "[RegistryClassGlobal]") {
    RegistryClassGlobal registry;
...
TEST_CASE("Generer un message d'error personnalise avec callback", "[RegistryClassGlobal]") {
    RegistryClassGlobal registry;
...
TEST_CASE("Recuperation correcte des cles du registry", "[RegistryClassGlobal]") {
    RegistryClassGlobal registry;
